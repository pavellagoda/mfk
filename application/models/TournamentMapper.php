...
class models_TournamentMapper extends models_MapperBase
{

	public static $_dbTable = 'models_DbTable_Tournament';
	...
	public static function findById ($idTournamet)
	{
		$db = self::_getDbTable(self::$_dbTable);
		
		$select = $db->select();
		
		$select->where('id = ?', $idTournamet);
